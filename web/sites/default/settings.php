 ...
 * @endcode
 */
$settings['hash_salt'] = 'yTyrc-Zh3UbJrzg10BgbDB-ifoaDpJuVDBXPcfT-CNpegPuT77QMrgdXD0MtS-yxtO8ctdQOuw';
...
// Don't forget your hash salt!
$settings['hash_salt'] = getenv('DRUPAL_HASH_SALT');

// It's also a good idea to add trusted host patterns for security.
if (getenv('ROOT_DOMAIN')) {
  $settings['trusted_host_patterns'] = [
    '^' . str_replace('.', '\.', getenv('ROOT_DOMAIN')) . '$',
  ];
}
